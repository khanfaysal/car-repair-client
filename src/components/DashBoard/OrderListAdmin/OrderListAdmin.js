...
const ManageService = () => {
  ...
  useEffect(() => {
    fetch("https://car-repair-server-kappa.vercel.app/orders")
      .then((res) => res.json())
  ...
  const updateService = (id, status) => {
    ...
    fetch("https://car-repair-server-kappa.vercel.app/updateOrder/" + id, {
      method: "PATCH",
      headers: {
  ...
  const handleStatusChange = async (e) => {
    ...
    // Load Product
    await fetch(`https://car-repair-server-kappa.vercel.app/order/${e.target.id}`)
      .then((res) => res.json())
      .then((data) => {
        console.log(data);
      });
